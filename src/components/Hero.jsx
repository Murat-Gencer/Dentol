...
export default function Hero() {
  return (
    <section id="ana-sayfa" className="relative flex flex-col lg:flex-row items-center justify-between gap-12 px-4 py-12 md:px-10 md:py-20 overflow-hidden">
      ...
      <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-6 lg:w-1/2">
        <span className="text-sm font-bold uppercase tracking-widest text-[#d6ad4c]">DENTOL DİŞ KLİNİĞİ</span>
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tighter">GÜLÜŞ BİR KARARDIR</h1>
        <p className="text-black text-sm md:text-base font-normal leading-relaxed max-w-xl">Dentol Ağız ve Diş Sağlığı Polikliniği, modern teknolojiler ve etik hekimlik anlayışıyla ağız ve diş sağlığında ayrıcalıklı bir deneyim sunar.
...
Konforlu klinik ortamımızda sağlıklı, doğal ve özgüvenli gülüşler tasarlıyoruz.</p>
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-6">
          <a href="tel:+902582631020" className="flex min-w-[180px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-14 px-8 bg-[#d6ad4c] text-slate-50 text-base font-bold leading-normal tracking-wide shadow-lg hover:shadow-xl hover:bg-opacity-90 transform hover:scale-105 transition-all duration-300">
            <span className="truncate">Randevu Al</span>
          </a>
          <button className="min-w-[180px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-14 px-8 bg-transparent text-[#d6ad4c] text-base font-bold leading-normal tracking-wide ring-2 ring-inset ring-[#d6ad4c] hover:bg-[#d6ad4c]/10 transform hover:scale-105 transition-all duration-300">
      ...
      <div className="lg:w-1/2 w-full max-w-lg relative">
        ...
        <div className="absolute -bottom-8 -right-8 w-48 h-48 bg-[#d6ad4c]/20 dark:bg-[#d6ad4c]/30 rounded-full blur-3xl -z-10"></div>
